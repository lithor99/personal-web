    ...
    <div class="relative z-10">
      ...
      <section class="relative text-center py-10 bg-black/0 backdrop-blur-none">
        <div class="container mx-auto">
          ...
          >
            <div
              class="bg-[url('/images/i.png')] bg-cover bg-center rounded-full mx-auto flex items-center justify-center hover:scale-105 transition-transform duration-300 cursor-pointer"
              style="width: 180px; height: 180px"
              @click="openModal"
            ></div>
          </div>
          <h1 class="text-5xl font-bold mt-10 text-yellow-500 animate-pulse">
            LITHOR XIAYE
          </h1>
          <p
            class="p-4 text-gray-200 text-xl max-w-2xl backdrop-blur-sm bg-black/0 rounded-lg mx-auto mt-2"
            style="width: 100%; max-width: 800px"
          >
            <span>
              👋 Hello, my name is LITHOR XIAYE, I am a software developer. I
              graduated from National University of Laos, Faculty of Natural
              Sciences, Department of Computer Science.<br />I have more than
              <span class="text-yellow-500 font-bold">{{
                new Date().getFullYear() - 2021
              }}</span>
              years of experience. I can help you solve all your business
              problems by software applocation. Please contact me if you need 🤗
            </span>
          </p>
          <div class="flex items-center justify-center mt-4">
            ...
            >
              <div
                class="bg-gray-900 rounded-full mx-auto flex items-center justify-center"
        ...
        <div class="flex justify-center items-center">
          <div
            class="px-10 py-4 mt-8 mx-4 rounded-lg text-white backdrop-blur-sm bg-black/0 border border-white/10"
            style="width: 100%; max-width: 800px"
          >
            ...
            <div
              class="flex flex-col mb-2 sm:flex-row gap-4 justify-center items-center"
            >
              <!-- View CV Button -->
              <button
                @click="viewCV"
              ...
              <button
                @click="downloadCV"
                class="group relative bg-gradient-to-r from-blue-400 to-blue-500 text-gray-900 font-bold py-3 px-6 rounded-lg hover:from-blue-400 hover:to-blue-500 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-blue-500/50 flex items-center gap-2 min-w-[150px] justify-center"
              >
                <Icon icon="streamline:download-circle-solid" class="w-5 h-5" />
        ...
        <div class="flex justify-center items-center">
          <div
            class="px-10 py-4 mx-4 mt-8 rounded-lg text-white backdrop-blur-sm bg-black/0 border border-white/10"
            style="width: 100%; max-width: 800px"
          >
            <h2 class="text-2xl font-bold mb-4 text-center text-yellow-600">
              Programming Skills
            </h2>
            ...
            <div v-for="skill in skills" :key="skill.name" class="mb-4">
              ...
              <div
                class="bg-gray-300/30 h-4 rounded-full mt-2 backdrop-blur-sm"
              >
                <div
                  class="bg-gradient-to-r from-yellow-300 to-orange-500 h-4 rounded-full transition-all duration-500 ease-out shadow-lg"
        ...
        <div class="flex justify-center items-center">
          <div
            class="w-max backdrop-blur-sm bg-black/0 rounded-lg p-6 mt-8 mx-4 border border-white/10"
          >
            <h2 class="text-2xl font-bold text-center text-yellow-600">
              Work Experience
            </h2>
            <div class="max-w-4xl mx-auto mt-6 text-left">
              <ul class="list-disc list-inside space-y-2">
                <li
                  class="hover:bg-yellow-500/5 p-4 rounded-lg transition-colors duration-300"
                >
                  <strong class="text-yellow-400"
                    >Front-end and Mobile Application Developer at Simple Tech
                    CO., LTD</strong
                  >
                  - 2025 to Present
                  <p class="text-gray-300 ml-5 mt-2">
                    Develop, manage and support various web and mobile
                    applications for Kamphaeng Saen University, Savannakhet
                    University, Northern College of Finance, Southern College of
                    Finance and Academy of Finance and Accounting. Using NuxtJS,
                    ReactJS, Flutter, NestJS with PostgreSQL and MongoDB
                    Database.
                  </p>
                </li>
                <li
                ...
                >
                  <strong class="text-yellow-400"
                    >Full Stack Developer at Agricultural Promotion Bank CO.,
                    LTD (APB)</strong
                  >
                  - 2023 to 2025
                  <p class="text-gray-300 ml-5 mt-2">
                    Develop, manage, and support various web and mobile
                    applications for clients. Development frameworks include
                    Flutter, NuxtJS, ReactJS, NodeJS, NestJS, Golang and
                    Database by MySQL.
                  </p>
                </li>
                <li
                ...
                >
                  <strong class="text-yellow-400"
                    >Frelance Software Developer</strong
                  >
                  - 2022 to 2023
                  <p class="text-gray-300 ml-5 mt-2">
                    Develop, manage and support various web and mobile
                    applications for clients. Using NuxtJS, Flutter, NodeJS with
                ...
                >
                  <strong class="text-yellow-400"
                    >Software Developer at Souvanny Home Center Public
                    Company</strong
                  >
                  - 2021 to 2022
                  <p class="text-gray-300 ml-5 mt-2">
                    Develop, manage and support various web and mobile
                    applications for clients. Using C#, Flutter, PostgreSQL
                    Database.
                  </p>
                </li>
              </ul>
        ...
        <div class="container mx-auto text-center">
          <div
            class="backdrop-blur-sm bg-black/0 rounded-lg px-8 py-6 mt-8 mx-4 border border-white/10"
          >
            ...
            >
              <div
                ...
                :key="project.id"
                class="backdrop-blur-sm bg-black/0 shadow-md border border-yellow-600/50 rounded-lg p-2 hover:cursor-pointer hover:scale-105 transition-all duration-300 hover:shadow-2xl hover:shadow-yellow-600/50"
              ...
              >
                <img
                  ...
                  class="rounded"
                />
                <h3 class="mt-4 text-xl text-yellow-600 font-bold">
                  {{ project.title }}
                </h3>
      ...
      <!-- Footer -->
      <footer
        class="bg-yellow-600/90 text-center text-white py-4 backdrop-blur-sm"
      >
        <p class="text-gray-800">
          &copy; 2025 LITHOR XIAYE. All rights reserved.
        </p>
      </footer>
    </div>
...
const socialLinks = [
  ...
  },
  {
    ...
    tooltip: "Whatsapp",
    action: () => openWhatsApp("+8562078966646", "ສະບາຍດີ LITHOR"),
  },
  {
    id: "facebook",
    icon: "mdi:facebook",
    iconClass: "w-7 h-7 text-yellow-500",
    tooltip: "Facebook",
    action: () => openLink("https://www.facebook.com/leethorxiongpor"),
  },
  {
    id: "email",
    ...
    tooltip: "Email",
    action: () =>
      openEmail("lithor99@gmail.com", {
        cc: [],
        bcc: "",
        subject: "Hello LITHOR",
        body: "This message from your personal website.",
        preferGmail: true,
      }),
  },
  {
...
const openEmail = (to, opts = {}) => {
  const enc = (v) => (v ? encodeURIComponent(v) : "");
  const join = (v) => (Array.isArray(v) ? v.join(",") : v || "");

  const toJoined = join(to);
  const ccJoined = join(opts.cc);
  const bccJoined = join(opts.bcc);

  if (opts.preferGmail) {
    // Open Gmail compose in a new tab
    const params = new URLSearchParams();
    if (toJoined) params.set("to", toJoined);
    if (ccJoined) params.set("cc", ccJoined);
    if (bccJoined) params.set("bcc", bccJoined);
  ...
  // Fallback: use default mail client via mailto:
  const parts = [];
  if (ccJoined) parts.push(`cc=${enc(ccJoined)}`);
  if (bccJoined) parts.push(`bcc=${enc(bccJoined)}`);
  if (opts.subject) parts.push(`subject=${enc(opts.subject)}`);
  if (opts.body) parts.push(`body=${enc(opts.body)}`);
  const query = parts.length ? `?${parts.join("&")}` : "";
  const url = `mailto:${toJoined}${query}`;

  // Using location.href is more reliable for mailto: than window.open in some browsers
...
class NetworkAnimation {
  ...
  drawConnections() {
    ...
    for (
      let i = 0;
      i < this.nodes.length && connectionCount < this.maxConnections;
      i++
    ) {
      for (
        let j = i + 1;
        j < this.nodes.length && connectionCount < this.maxConnections;
        j++
      ) {
